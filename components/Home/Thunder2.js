...
export default function Thunder2() {
  return (
    <section className="flex justify-center self-center items-center relative lg:h-[1000px] h-[750px]" id="thunder2">
      ...
      <Swords className="absolute z-10 xl:bottom-20 lg:bottom-32 md:bottom-20 bottom-0 -translate-x-32 md:-translate-x-[100%] lg:-translate-x-[175%] xl:-translate-x-[230%] scale-75 lg:scale-100"/>
      ...
      <div className="absolute text-back-lite gap-5 flex flex-col items-center text-center translate-y-24 md:translate-y-20 scale-75 2xl:scale-100 max-w-[400px] sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl z-10">
